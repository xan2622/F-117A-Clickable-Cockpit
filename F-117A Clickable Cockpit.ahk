...
---------------------------------------------------------------------------- 
	...
	- Hide overlays if mouse cursor is outside the DOSBox window 
	...
	- Activate the Eject button only after holding the left mouse button down for 3 seconds 
	...
	- Add (convenient) extra buttons that are not in the original game: such as "50% Throttle/Power" (there's one free MFD button on the left MFD)
